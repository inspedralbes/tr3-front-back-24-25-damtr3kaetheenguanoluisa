<template>
  <div class="bomberman-login-container">
      ...
      <div class="login-card">
        <div class="card-header">
          <div class="game-logo">
            ...
            <h1 class="logo-text">BOMBER<span>LOGIN</span></h1>
          </div>
        </div>
        ...
        <div class="login-form">
          ...
          <div class="button-group">
            <button @click="handleLogin" class="game-button primary-button">
              <span class="button-text">LOGIN</span>
              <span class="button-shine"></span>
            </button>
            <NuxtLink to="/register" class="game-button secondary-button">
